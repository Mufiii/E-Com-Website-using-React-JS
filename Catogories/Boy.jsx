...
function Products() {
  ...
  const data = proData.filter((item) => item.type === 'boy' )
  console.log(data);
  ...
  return (
    <div>
        ...
        {data.map ((item) =>{
            return <Card className='shadow p-3 mb-3 bg-body rounded  mt-3 W-75'  style={{ width: '18rem',alignItems:'center' }} key={item.id}>
